...
assert.match(routeMap.innerHTML, /data-map-layer-action="select-all"/i);
assert.match(routeMap.innerHTML, /data-map-layer-action="clear-all"/i);
assert.match(routeMap.innerHTML, /data-map-layer-toggle="urban-evidence"/i);
